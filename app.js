...
function analyzeCriminalLocations() {
  ...
  let sortedCriminalLocationsFrequency = Object.values(
    criminalLocationsFrequency
  ...
  for (let i = 0; i < sortedCriminalLocationsFrequency.length; i++) {
    ...
    locationDisplay.textContent = `${
      currentKey.name_of_place.charAt(0).toUpperCase() +
      currentKey.name_of_place.slice(1)
    }: ${currentKey.count} time(s)`;
